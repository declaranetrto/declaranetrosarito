...
public class HealthChecks extends AbstractVerticle{
    ...
    private static final Integer port = Integer.parseInt(System.getenv(IP_SERVER_PORT) != null ? System.getenv(IP_SERVER_PORT) : "8081");
    ...
    public void start() throws Exception {
        super.start(); 
        vertx.eventBus().consumer(healthChecks, message ->{
