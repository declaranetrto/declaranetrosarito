 ...
 */
package mx.gob.sfp.dgti.recepdeclaracion;

import io.vertx.core.Future;
import io.vertx.core.Vertx;
import io.vertx.core.logging.Logger;
import io.vertx.core.logging.LoggerFactory;
import mx.gob.sfp.dgti.recepdeclaracion.despliegue.DeployConfig;
import mx.gob.sfp.dgti.recepdeclaracion.despliegue.VerticleConfig;
...
public class MainDeployer extends VerticleConfig {
    ...
    private static final String VERTICLE_HTTP =
            "mx.gob.sfp.dgti.recepdeclaracion.server.ServerVerticle";

    /**
     * Verticle de Http
     */
    private static final String VERTICLE_LLAMADOR_CATALOGOS =
            "mx.gob.sfp.dgti.recepdeclaracion.servicioext.LlamadorCatalogosVerticle";
    ...
    public MainDeployer(){//default implementation
    }
    ...
    public void start(Future<Void> startFuture) throws Exception {
        LOGGER.info("=== Inicia deploy en MainDeployer");
        List<DeployConfig> deploys = new ArrayList<>();
        deploys.add(new DeployConfig(VERTICLE_HTTP, VRTX_INSTANCIAS_HTTP, VRTX_WKER_POOL));
        deploys.add(new DeployConfig(VERTICLE_LLAMADOR_CATALOGOS, VRTX_INSTANCIAS_LLAMADOR, VRTX_WKER_POOL));
