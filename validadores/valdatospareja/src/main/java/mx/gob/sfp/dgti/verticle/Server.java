...
public class Server extends AbstractVerticle {
	...
	/**
	 * Validador del módulo de datos de pareja
	...
	private void validarDomDecl(RoutingContext context) {
		...
		if(!context.getBodyAsString().equals("")) {
			try {
				...
				DatosParejasDTO datosParejasDto = Json.decodeValue(context.getBodyAsString(),
						DatosParejasDTO.class);

				validacion.validar(datosParejasDto).setHandler(modulo -> {
					if (modulo.succeeded()) {
