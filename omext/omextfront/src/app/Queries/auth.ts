...
export class AUTH {
  ...
  public static UPDATE_USER = gql`
    query updateUser($_curp: String!, $_user: updateUser!) {
      updateUser(app: "OMEXT", curp: $_curp, user: $_user) {
        error
        msj
      }
    }
...
id : idEntidadFederativa valor: entidadFederativaDesc municipio{ id: idMunicipio valor :  municipioDesc
  ...
  */
  ...
  public static buscarServidores = gql`
    query buscarServidores($filtro: FiltroBusqServInput!) {
      buscarServidores(filtro: $filtro) {
        servidoresPublicos {
          activo
          fechaRegistro
          cumplimiento
  ...
  public static getInstituciones = gql`
    query obtenerInformacionInst($collname:Int!,$condiciones: CondicionesInstInput!) {
  ...
  public static descargarReporte = gql`
  query generarReporteServidores($filtro : FiltroReporteServidoresInput!) {
    generarReporteServidores(filtro : $filtro)  
  }
  `;

  public static guardarUsuario = gql`
  mutation guardaUser($user: regUser!) {
  ...
  public static updateUser = gql`
  mutation updateUser($app: String!, $curp: String!, $user: updateUser!) {
    updateUser(app: $app, curp: $curp, user: $user) {
      error
      msj
    }
  }
`;
  ...
  query getUser($app: String!, $curp: String!){
    getUser(app: $app, curp: $curp) {
      curp
      user
      email
      active
