...
@Component({
  selector: 'app-revertimiento-manual',
  templateUrl: './revertimiento-manual.component.html',
  styleUrls: ['./revertimiento-manual.component.scss']
})
export class RevertimientoManualComponent implements OnInit {
  servidorPublico: any = {};
  datosCard: any = {};
  ...
  ngOnInit() {
    ...
    if (this.datos) {
      console.log('desde hijo', this.datos);
  ...
  buscarComprobante() {
    console.log('no comprobante ', this.noComprobante);
    console.log('coll ', this.instReceptora.collName);
