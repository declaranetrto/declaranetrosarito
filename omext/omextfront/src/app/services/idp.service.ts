...
export class IdpService {
  ...
  iniciarToken(userToken: any){
    // return this.http.post<any>(`https://686-review-inicio-1yifk0.dkla8s.sfp.gob.mx/inicio/iniciar`, userToken, { observe: 'response'})
  ...
  seleccionarPerfil(perfil: any) {
    ...
    return this.http.post<any>(`${environment.API_KONG}/seguridad/seleccionado`, perfil, { observe: 'response'})
  ...
  getUserbyId(usuario: any, collName: number) {
    return this.http.get<any>(`${environment.API_KONG}/seguridad/asignacion/datos/${collName}/${usuario.idUsuario}/${usuario.curp}`, { observe: 'response'})
    .pipe(map(catalogo => {
      return catalogo;
  }));
  }
  createUser(body: any, collName: number, curp: string){
    // return this.http.post<any>(`${environment.API_BASE}/oper/iniciar`, userToken, { observe: 'response'})
    return this.http.put<any>(`${environment.API_KONG}/seguridad/asignacion/${collName}/${environment.ID_CLIENTE}/${curp}`, body, { observe: 'response'})
    // body = {};
  ...
  updateUser(body: any, collName: number){
    // return this.http.post<any>(`${environment.API_BASE}/oper/iniciar`, userToken, { observe: 'response'})
    return this.http.patch<any>(`${environment.API_KONG}/seguridad/asignacion/${collName}/${environment.ID_CLIENTE}/x`, body, { observe: 'response'})
    // body = {};
  ...
  recuperaToken(){
    // return this.http.post<any>(`${environment.API_BASE}/oper/iniciar`, userToken, { observe: 'response'})
    return this.http.get<any>(`${environment.API_KONG}/seguridad/seleccionado`, { observe: 'response'})
