...
public abstract class VerticalConfig extends AbstractVerticle  {
    ...
    private static final Integer VRTX_WKER_POOL = Integer.parseInt(System.getenv(VAR_NAME_VRTX_WKER_POOL) != null ? System.getenv(VAR_NAME_VRTX_WKER_POOL) : "20");
    /**
     ...
     * 
     * @param verticles Lista de String's que definen el paquete's.nombreVerticle donde se encuentran el vertical que se pretenden lebantar.
     */
     ...
     * 
     * @param verticle String que define el paquete.nombre del vertical que se pretende lebantar.
     */
