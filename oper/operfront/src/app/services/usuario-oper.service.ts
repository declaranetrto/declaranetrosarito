...
export class UsuarioOperService {
  ...
  getPerfiles(collName: string) {
    return this.http.post<any>(`${environment.API_BASE}/seguridad/perfil/${collName}/${environment.ID_CLIENTE}/ADMINISTRADOR`, {}, { observe: 'response' })
    .pipe(map(registro => {
        console.log(registro);
        return registro;
    }));
