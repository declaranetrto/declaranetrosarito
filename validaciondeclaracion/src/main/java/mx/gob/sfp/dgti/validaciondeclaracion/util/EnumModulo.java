...
public enum EnumModulo {
	...
	IDS("ids"),
	CAMBIO_DEPENDENCIA("detalleAvisoCambioDependencia"),
	NOTAS_ACLARATORIAS("notasAclaratorias");
	 ...
	 * @return
	 */
	public static EnumModulo obtenerEnum(String modulo) {
		return Arrays.asList(values()).stream()
				.filter(enumModulo -> enumModulo.getModulo().equals(modulo))
				.findFirst()
				.orElse(null);
	}
}
