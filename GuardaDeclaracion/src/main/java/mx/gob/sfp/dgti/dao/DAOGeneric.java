...
public class DAOGeneric {
    ...
    private static final String HOST_IP = System.getenv(HOST)!= null ? System.getenv(HOST) : "";
    private static final String PORT="port";
    private static final Integer PORT_NUMBER = System.getenv(PORT) != null ? Integer.parseInt(System.getenv(PORT)): 27021;
    ...
    private static final String USER_NAME_VALUE = System.getenv(USER_NAME)!= null ? System.getenv(USER_NAME): "";
    private static final String P_W_D="password";
    private static final String P_W_D_VALUE = System.getenv(P_W_D) != null ? System.getenv(P_W_D): "";
    private static final String DB_NAME="db_name";
    private static final String DB_NAME_VALUE=System.getenv(DB_NAME) != null ? System.getenv(DB_NAME): "";
    private static final String KEEP_ALIVE ="keepAlive";
    protected final MongoClient mongoClient;
    
    protected DAOGeneric(Vertx vertx){
